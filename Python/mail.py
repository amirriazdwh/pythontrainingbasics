...
Hadoop Team
"""
  v_log_path='/home/cibg_uat_user/obtf/qc_framework/output/executor_result_{}.csv'.format(datetime.now().strftime('%Y%m%d'))
...
Hadoop Team
"""
  v_log_path='/home/cibg_uat_user/DigiCollect/obtf/qc_framework/output/executor_result_{}.csv'.format(datetime.now().strftime('%Y%m%d'))
