...
are none point to same memory address.  this singleton class is load into memory like a static class so its
memory address is same throughout the program
