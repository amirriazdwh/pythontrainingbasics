...
#
#  an iterator is an abstract method of collection class from which data types like String, list , tuple, dictionary, set are
#  being derived therefore a list with string may return Iterator[String],  [] describe the type of list elements.  
#   
