...
1.  Python Architecture is made up of three layers scope.
        ...
        1.2   Global scope
        1.3   local scope.
 2. Everything in python is an object.   class,  data types,  functions,  import ,  modules,   anything which is
 either a scope or an object has directionary where they store data.
 3. .
...
All of these brackets are also used in regex. Basically, [] are used for character classes, () for grouping,
and {} for repetition. For details, see The Regular Expressions FAQ.
